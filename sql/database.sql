...
-- Seed songs
INSERT INTO `songs` (`id_song`, `title`, `artist`, `link`) VALUES
(1, 'Glimpse of Us', 'Joji', 'https://www.youtube.com/watch?v=FvOpPnUXRYY'),
(2, 'Heather', 'Conan Gray', 'https://www.youtube.com/watch?v=24u3NoPmgpg'),
(3, 'Someone Like You', 'Adele', 'https://www.youtube.com/watch?v=hLQl3WQQoQ0'),
(4, 'Happier', 'Olivia Rodrigo', 'https://www.youtube.com/watch?v=Z5g_7-gN0B8'),
(5, 'Ghost', 'Justin Bieber', 'https://www.youtube.com/watch?v=F5tSoaJ93ac'),
(6, 'Hati-Hati di Jalan', 'Tulus', 'https://www.youtube.com/watch?v=d_M2HkXFGl0'),
(7, 'Monokrom', 'Tulus', 'https://www.youtube.com/watch?v=0k5G6GfGkkw'),
(8, 'Sempurna', 'Andra and The Backbone', 'https://www.youtube.com/watch?v=4b78p2rWl0c');
